...
Gem::Specification.new do |spec|
  spec.name          = "artery-browser"
  spec.version       = Artery::Browser::VERSION
  spec.authors       = ["Askar Zinurov"]
  spec.email         = ["askar.zinurov@flant.com"]

  spec.summary       = %q{Admin Browser for artery configuration}
  spec.description   = %q{Admin Browser for artery configuration.}
